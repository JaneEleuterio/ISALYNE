...
import conn_CreditCard_Payment.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ICreditCardManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(ICreditCardManagerTag, payment.req.ICreditCardManager.class);

        //required
        this.setRequiredInterfaceTypes(ICreditCardManagerTag, creditCard.prov.ICreditCardManager.class);
    }
