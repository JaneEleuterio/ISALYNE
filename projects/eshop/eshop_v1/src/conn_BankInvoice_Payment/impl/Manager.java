...
import conn_BankInvoice_Payment.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IBankInvoiceManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IBankInvoiceManagerTag, payment.req.IBankInvoiceManager.class);

        //required
        this.setRequiredInterfaceTypes(IBankInvoiceManagerTag, bankInvoice.prov.IBankInvoiceManager.class);
    }
