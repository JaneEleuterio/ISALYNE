...
import conn_VisaC_VisaCSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IVisaManagerTag, visaCSensor.req.IVisaManager.class);

        //required
        this.setRequiredInterfaceTypes(IVisaManagerTag, visaC.prov.IVisaManager.class);
    }
