...
import conn_Payment_Controller.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IPaymentManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IPaymentManagerTag, controller.req.IPaymentManager.class);

        //required
        this.setRequiredInterfaceTypes(IPaymentManagerTag, payment.prov.IPaymentManager.class);
    }
