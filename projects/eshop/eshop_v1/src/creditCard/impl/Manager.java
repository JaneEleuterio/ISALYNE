...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ICreditCardManagerProv, new ICreditCardManagerFacade(this));
        this.setProvidedInterfaceTypes(ICreditCardManagerProv, ICreditCardManager.class);
		

        //required 
        this.setRequiredInterfaceTypes(IMasterCardManagerReq, IMasterCardManager.class);
