...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IMoneyPaymentManagerProv, new IMoneyPaymentManagerFacade(this));
        this.setProvidedInterfaceTypes(IMoneyPaymentManagerProv, IMoneyPaymentManager.class);
