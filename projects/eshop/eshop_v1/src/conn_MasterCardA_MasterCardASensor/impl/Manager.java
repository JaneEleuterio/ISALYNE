...
import conn_MasterCardA_MasterCardASensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IMasterCardManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IMasterCardManagerTag, masterCardASensor.req.IMasterCardManager.class);

        //required
        this.setRequiredInterfaceTypes(IMasterCardManagerTag, masterCardA.prov.IMasterCardManager.class);
    }
