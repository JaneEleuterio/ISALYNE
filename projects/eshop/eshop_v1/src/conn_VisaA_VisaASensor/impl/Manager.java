...
import conn_VisaA_VisaASensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IVisaManagerTag, visaASensor.req.IVisaManager.class);

        //required
        this.setRequiredInterfaceTypes(IVisaManagerTag, visaA.prov.IVisaManager.class);
    }
