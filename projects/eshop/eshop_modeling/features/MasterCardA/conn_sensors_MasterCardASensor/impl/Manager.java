...
import conn_sensors_MasterCardASensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new conn_sensors_MasterCardASensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, masterCardASensor.req.ISensorUpdater.class);

        //required
        this.setRequiredInterfaceTypes(ISensorUpdaterTag, mapekcosmos.sensors.prov.ISensorUpdater.class);
    }
