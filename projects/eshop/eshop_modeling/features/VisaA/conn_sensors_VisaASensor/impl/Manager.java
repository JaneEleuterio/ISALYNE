...
import conn_sensors_VisaASensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new conn_sensors_VisaASensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, visaASensor.req.ISensorUpdater.class);
