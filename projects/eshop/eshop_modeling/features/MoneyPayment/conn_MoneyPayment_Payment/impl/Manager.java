...
import conn_MoneyPayment_Payment.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IMoneyPaymentManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IMoneyPaymentManagerTag, payment.req.IMoneyPaymentManager.class);

        //required
        this.setRequiredInterfaceTypes(IMoneyPaymentManagerTag, moneyPayment.prov.IMoneyPaymentManager.class);
    }
