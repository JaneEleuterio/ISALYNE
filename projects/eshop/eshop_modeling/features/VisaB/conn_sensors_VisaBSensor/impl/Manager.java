...
import conn_sensors_VisaBSensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new conn_sensors_VisaBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, visaBSensor.req.ISensorUpdater.class);
