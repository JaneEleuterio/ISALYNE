...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IMasterCardManagerProv, new IMasterCardManagerFacade(this));
        this.setProvidedInterfaceTypes(IMasterCardManagerProv, IMasterCardManager.class);
