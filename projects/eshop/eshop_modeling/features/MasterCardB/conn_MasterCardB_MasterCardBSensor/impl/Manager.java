...
import conn_MasterCardB_MasterCardBSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IMasterCardManagerTag, masterCardBSensor.req.IMasterCardManager.class);

        //required
        this.setRequiredInterfaceTypes(IMasterCardManagerTag, masterCardB.prov.IMasterCardManager.class);
    }
