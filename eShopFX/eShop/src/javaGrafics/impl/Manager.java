...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IGUIManagerProv, new IGUIManagerFacade(this));
        this.setProvidedInterfaceTypes(IGUIManagerProv, IGUIManager.class);
