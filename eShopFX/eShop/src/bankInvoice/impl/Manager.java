...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IBankInvoiceManagerProv, new IBankInvoiceManagerFacade(this));
        this.setProvidedInterfaceTypes(IBankInvoiceManagerProv, IBankInvoiceManager.class);
