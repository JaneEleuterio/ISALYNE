...
import conn_Java_Controller.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IGUIManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IGUIManagerTag, controller.req.IGUIManager.class);

        //required
        this.setRequiredInterfaceTypes(IGUIManagerTag, javaGrafics.prov.IGUIManager.class);
    }
