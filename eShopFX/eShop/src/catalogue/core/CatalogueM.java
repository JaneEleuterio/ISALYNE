...
public class CatalogueM {
	...
	*/
     ...
     * @param nome String
     * @return Produto caso encontre, null caso contrário.
     */
    ...
    /**
     * Método que que busca todos os produtos
     * @return ObservableList<Produto>; Lista com todos os produtos do catálogo.
     */
