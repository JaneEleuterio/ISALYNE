...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IBankTransferManagerProv, new IBankTransferManagerFacade(this));
        this.setProvidedInterfaceTypes(IBankTransferManagerProv, IBankTransferManager.class);
