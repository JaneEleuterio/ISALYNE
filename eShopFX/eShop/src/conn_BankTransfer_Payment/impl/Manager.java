...
import conn_BankTransfer_Payment.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IBankTransferManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IBankTransferManagerTag, payment.req.IBankTransferManager.class);

        //required
        this.setRequiredInterfaceTypes(IBankTransferManagerTag, bankTransfer.prov.IBankTransferManager.class);
    }
