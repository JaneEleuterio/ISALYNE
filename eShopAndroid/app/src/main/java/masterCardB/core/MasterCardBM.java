...
/**
 * Created by COSMAPE-Feature IDE on 2016-jul-11. Feature: MasterCardB
 * Component: MasterCardB
 *
 * This class contains the concrete methods of component 'MasterCardB'.
 */
public class MasterCardBM {
	private IManager manager;

	public MasterCardBM(IManager manager) {
	...
	/*
	 * public synchronized type businessMethod(param) { getManagers(); ...
	 * return something; }
	 */
	public synchronized  boolean getDisponibilidade()  {
		...
		try{
		String url = "http://" + App.servidor +  ":" + 8184 + "/" + "master"
				+ "/disponibilidade";
	...
	private String compra(float valor, String nomeCartao, String numeroCartao,
			String validadeCartao, String cifCartao, int parcelas)
			throws IOException {
		// Montando a URL
		String url = "http://" + App.servidor +  ":" + 8184 + "/" + "master"
				+ "/registraCompra";
	...
	public synchronized String pagarMaster(float valor, String nomeCartao,
			String numeroCartao, String validadeCartao, String cifCartao,
			int parcelas) {
		getManagers();
		String resu = null;
		...
		try {
			...
			resu = compra(valor, nomeCartao, numeroCartao, validadeCartao,
					cifCartao, parcelas);
		} catch (Exception e) {
			e.printStackTrace();
		}
