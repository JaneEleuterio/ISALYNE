 ...
 * Component: VisaB
 *
 * This class contains the concrete methods of component 'VisaB'.
 */
public class VisaBM {
    private IManager manager;

    
    public VisaBM(IManager manager) {
	...
	*/
    public synchronized  boolean getDisponibilidade() {
    	...
    	boolean resu = false;
    	try{
		String url = "http://" + App.servidor +  ":" + 8181 + "/" + "visa" + "/disponibilidade";
    ...
    private String compra(float valor ,String nomeCartao , String numeroCartao,String validadeCartao,String cifCartao , int parcelas) throws IOException {
		// Montando a URL
		String url = "http://" + App.servidor +  ":" + 8181 + "/" + "visa" + "/registraCompra";
