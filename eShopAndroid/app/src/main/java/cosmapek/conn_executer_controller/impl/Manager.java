...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IExecutionManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IExecutionManagerTag,
            cosmapek.controller.req.IExecutionManager.class);

        //required
        this.setRequiredInterfaceTypes(IExecutionManagerTag, cosmapek.executer.prov.IExecutionManager.class);
    }
