...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IVariabilityManagerProv, new IVariabilityManagerFacade(this));
        this.setProvidedInterfaceTypes(IVariabilityManagerProv, IVariabilityManager.class);
