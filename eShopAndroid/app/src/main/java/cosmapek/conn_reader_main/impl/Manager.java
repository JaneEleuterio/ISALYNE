...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IReadingManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IReadingManagerTag, cosmapek.main.req.IReadingManager.class);

        //required
        this.setRequiredInterfaceTypes(IReadingManagerTag, cosmapek.reader.prov.IReadingManager.class);
    }
