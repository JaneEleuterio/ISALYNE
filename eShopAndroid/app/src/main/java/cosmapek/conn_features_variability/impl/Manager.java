...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IFeatureManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IFeatureManagerTag, cosmapek.variability.req.IFeatureManager.class);

        //required
        this.setRequiredInterfaceTypes(IFeatureManagerTag, cosmapek.features.prov.IFeatureManager.class);
    }
