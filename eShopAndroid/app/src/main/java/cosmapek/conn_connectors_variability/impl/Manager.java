...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConnectorManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IConnectorManagerTag,
            cosmapek.variability.req.IConnectorManager.class);

        //required
        this.setRequiredInterfaceTypes(IConnectorManagerTag,
            cosmapek.connectors.prov.IConnectorManager.class);
    }
