...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IPlanningManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IPlanningManagerTag, cosmapek.controller.req.IPlanningManager.class);

        //required
        this.setRequiredInterfaceTypes(IPlanningManagerTag, cosmapek.planner.prov.IPlanningManager.class);
    }
