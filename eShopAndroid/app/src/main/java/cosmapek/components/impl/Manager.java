...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IComponentManagerProv, new IComponentManagerFacade(this));
        this.setProvidedInterfaceTypes(IComponentManagerProv, IComponentManager.class);
