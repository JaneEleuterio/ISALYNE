...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IComponentManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IComponentManagerTag,
            cosmapek.variability.req.IComponentManager.class);

        //required
        this.setRequiredInterfaceTypes(IComponentManagerTag,
            cosmapek.components.prov.IComponentManager.class);
    }
