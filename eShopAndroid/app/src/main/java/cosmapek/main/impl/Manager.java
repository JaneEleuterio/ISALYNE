...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILauncherProv, new ILauncherFacade(this));
        this.setProvidedInterfaceTypes(ILauncherProv, ILauncher.class);

        //required
        this.setRequiredInterfaceTypes(IControllerManagerReq, IControllerManager.class);
        this.setRequiredInterfaceTypes(IReadingManagerReq, IReadingManager.class);
    }
