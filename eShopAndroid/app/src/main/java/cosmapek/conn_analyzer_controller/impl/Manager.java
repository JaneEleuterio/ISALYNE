...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IAnalysisManagerTag, cosmapek.controller.req.IAnalysisManager.class);

        //required
        this.setRequiredInterfaceTypes(IAnalysisManagerTag, cosmapek.analyzer.prov.IAnalysisManager.class);
    }
