...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(ISensorManagerTag, cosmapek.variability.req.ISensorManager.class);

        //required
        this.setRequiredInterfaceTypes(ISensorManagerTag, cosmapek.sensors.prov.ISensorManager.class);
    }
