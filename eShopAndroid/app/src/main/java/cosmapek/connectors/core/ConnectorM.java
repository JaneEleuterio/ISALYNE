package cosmapek.connectors.core;
...
public class ConnectorM {
    ...
    private IConnectors connectors; //set of cosmapek.connectors
    private IConnectors connectorsinRuntime;// set of cosmapek.connectors
