...
import cosmapek.connectors.req.IComponentManager;
import cosmapek.connectors.prov.IConnectorManager;
import cosmapek.connectors.prov.IManager;
import cosmapek.connectors.req.ISensorManager;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConnectorManagerProv, new IConnectorManagerFacade(this));
        this.setProvidedInterfaceTypes(IConnectorManagerProv, IConnectorManager.class);
