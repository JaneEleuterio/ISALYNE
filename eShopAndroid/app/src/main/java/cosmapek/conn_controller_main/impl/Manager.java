...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IControllerManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(IControllerManagerTag, cosmapek.main.req.IControllerManager.class);

        //required
        this.setRequiredInterfaceTypes(IControllerManagerTag,
            cosmapek.controller.prov.IControllerManager.class);
    }
