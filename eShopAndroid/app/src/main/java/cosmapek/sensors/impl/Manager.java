...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorManagerProv, new ISensorManagerFacade(this));
        this.setProvidedInterfaceTypes(ISensorManagerProv, ISensorManager.class);

        this.setProvidedInterface(ISensorUpdaterProv, new ISensorUpdaterFacade(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterProv, ISensorUpdater.class);
        //required
