...
public class SensorM {
    ...
    private ISensors sensors; //set of cosmapek.sensors
    private ISensors sensorsinRuntime; //set of cosmapek.sensors
    ...
    private synchronized ISensor getASensorWith(String name) {
        for (ISensor s : sensors) {
            if (s.getName().equals(name)) {
                return s;
            }
