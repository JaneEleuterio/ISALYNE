...
import conn_Catalogue_Controller.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ICatalogueManagerTag, new Adapter(this));
        this.setProvidedInterfaceTypes(ICatalogueManagerTag, controller.req.ICatalogueManager.class);

        //required
        this.setRequiredInterfaceTypes(ICatalogueManagerTag, catalogue.prov.ICatalogueManager.class);
    }
