 ...
 * 
 * This interface is required by the 'VisaASensor' component (VisaASensor.req.IVisaManager). 
 * All signatures of business methods present here must be present in the 'IVisaManager' interface 
 * on the component origin (VisaA.prov.IVisaManager).
 */
public interface IVisaManager {
	...
	//the provider component (VisaA.prov.IVisaManager)
