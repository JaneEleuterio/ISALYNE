        ...
        this.turnOn = true;
            while (this.turnOn) {
                try {
					...
					//System.out.println("VisaA"+"Error = VisaA Sensor " + e.toString());
                    Log.d("VisaA", "Error = VisaA Sensor " + e.toString());
                }
            }
    ...
    private void executeSensor() {
        ...
        try{
            ...
            if((totalTime>100 && resu == false) || (resu == false)){
                ...
                //System.out.println("VisaA"+ "VisaA Sensor(Activated)I: "+timeSensorI+" " + nome + " Time: " + totalTime + " ");
                Log.d("VisaA", "VisaA Sensor(Activated)I: "+timeSensorI+" " + nome + " Time: " + totalTime + " ");
                ...
                //System.out.println("VisaA"+"VisaA Sensor(Activated)F: "+timeSensorF +" "+ nome + " Time: " + totalTime + " ");
                Log.d("VisaA", "VisaA Sensor(Activated)F: "+timeSensorF +" "+ nome + " Time: " + totalTime + " ");
            }if(totalTime < 100 && resu == true){
                long timeSensorI= System.currentTimeMillis();
                //TODO: log("VisaA", "VisaA Sensor(Deactivated)I: " + timeSensorI + " ");
                //System.out.println("VisaA"+"VisaA Sensor(Deactivated)I: " + timeSensorI + " ");
                Log.d("VisaA", "VisaA Sensor(Deactivated)I: " + timeSensorI + " ");

                sensorUpdater.deactivateSensor(nome);

                long timeSensorF= System.currentTimeMillis();
                //TODO: log("VisaA", "VisaA Sensor(Deactivated)F: " + timeSensorF + " ");
                //System.out.println("VisaA"+ "VisaA Sensor(Deactivated)F: " + timeSensorF + " ");
                Log.d("VisaA", "VisaA Sensor(Deactivated)F: " + timeSensorF + " ");
            }
        }catch (Exception e){
			// the component has a error
			e.printStackTrace();
            //TODO: log("VisaA", "VisaA Sensor Catch -> " + e.toString());
            //System.out.println("VisaA"+"VisaA Sensor Catch -> " + e.toString());
            Log.d("VisaA", "VisaA Sensor Catch -> " + e.toString());

			long timeSensorI= System.currentTimeMillis();
            //TODO: log("VisaA", "VisaA Sensor(Activated)I: " + timeSensorI + " ");
            //System.out.println("VisaA"+ "VisaA Sensor(Activated)I: " + timeSensorI + " ");
            Log.d("VisaA", "VisaA Sensor(Activated)I: " + timeSensorI + " ");

			sensorUpdater.activateSensor(nome);

            long timeSensorF= System.currentTimeMillis();
            //TODO: log("VisaA", "VisaA Sensor(Activated)F: " + timeSensorF + " ");
            //System.out.println("VisaA"+"VisaA Sensor(Activated)F: " + timeSensorF + " ");
            Log.d("VisaA", "VisaA Sensor(Activated)F: " + timeSensorF + " ");
        }
    }
