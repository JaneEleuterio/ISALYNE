        ...
        this.turnOn = true;
            while (this.turnOn) {
                try {
                    ...
                    Log.d("MasterCardA", "Error = MasterCardA Sensor " + e.toString());
                }
            }
        ...
        try{
           ...
           // this.i_IMasterCardManager.pagarMaster(valor, nomeCartao, numeroCartao, validadeCartao, cifCartao, parcelas);
            ...
            if((totalTime>100 && resu == false) || (resu == false)){
                ...
                Log.d("MasterCardA", "MasterCardA Sensor(Activated)I: "+timeSensorI+" " + nome + " Time: " + totalTime + " ");
                ...
                Log.d("MasterCardA", "MasterCardA Sensor(Activated)F: "+timeSensorF +" "+ nome + " Time: " + totalTime + " ");
                ...
                Log.d("MasterCardA", "MasterCardA Sensor(Deactivated)I: " + timeSensorI + " ");
                ...
                Log.d("MasterCardA", "MasterCardA Sensor(Deactivated)F: " + timeSensorF + " ");
            }
        }catch (Exception e){
            ...
            Log.d("MasterCardA", "MasterCardA"+ "MasterCardA Sensor Catch -> " + e.toString());
            ...
            Log.d("MasterCardA", "MasterCardA Sensor(Activated)I: " + timeSensorI + " ");
            ...
            Log.d("MasterCardA", "MasterCardA Sensor(Activated)F: " + timeSensorF + " ");
        }
    }
