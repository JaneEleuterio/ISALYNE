        ...
        this.turnOn = true;
            while (this.turnOn) {
                try {
                    ...
                    Log.d("VisaC", "Error = VisaC Sensor " + e.toString());
                }
            }
    ...
    private void executeSensor() {
        ...
        try{
            ...
            if((totalTime>100 && resu == false) || (resu == false)){
                ...
                Log.d("VisaC", "VisaC Sensor(Activated)I: "+timeSensorI+" " + nome + " Time: " + totalTime + " ");
                ...
                Log.d("VisaC", "VisaC Sensor(Activated)F: "+timeSensorF +" "+ nome + " Time: " + totalTime + " ");
                ...
                Log.d("VisaC", "VisaC Sensor(Deactivated)I: " + timeSensorI + " ");
                ...
                Log.d("VisaC", "VisaC Sensor(Deactivated)F: " + timeSensorF + " ");
            }
        }catch (Exception e){
            ...
            Log.d("VisaC", "VisaC Sensor(Activated)F: " + timeSensorF + " ");
        }
    }
